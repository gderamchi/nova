...
Supported actions: swap, bridge, transfer, balance, approve, wrap
...
Response format:
{
  "action": "swap|bridge|transfer|balance|approve|wrap|unknown",
...
Available actions: swap tokens, bridge cross-chain, check balances, transfer tokens.
